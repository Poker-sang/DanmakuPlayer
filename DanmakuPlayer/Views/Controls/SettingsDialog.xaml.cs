...
#pragma warning restore IDE0079 // 请删除不必要的忽略
    private void CompareChanges(AppConfig before, AppConfig after)
    {
        ...
        if (before.EnableWebView2 != after.EnableWebView2)
        {
            ...
            backgroundPanel.Vm.FullScreen = !after.EnableWebView2;
        }
        ...
        if (before.DanmakuCookie.SelectMany(_ => after.DanmakuCookie, (cookie1, cookie2) => (cookie1, cookie2))
            .Any(t => t.cookie1.Key != t.cookie2.Key || t.cookie1.Value != t.cookie2.Value))
